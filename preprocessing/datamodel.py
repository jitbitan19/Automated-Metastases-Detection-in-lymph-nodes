...
class SlideManager:
    ...
    def __init__(self, *, cam16_dir=None, cam17_dir=None):
        ...
        if cam16_dir is not None:
            ...
            self._path['cam16'] = {
                'dir': cam16_dir,
                # 'negative': os.path.join(cam16_dir, 'Camelyon16/Train_Normal'),
                # 'positive': os.path.join(cam16_dir, 'Camelyon16/Train_Tumor'),
                'negative': os.path.join(cam16_dir, 'jitbitan/Camelyon16/train/normal'),
                'positive': os.path.join(cam16_dir, 'jitbitan/Camelyon16/train/tumor'),
                'annotations': os.path.join(cam16_dir, 'jitbitan/Camelyon16/train/lesion_annotations'),
                'test': os.path.join(cam16_dir, 'Camelyon16_Test/images'), # NEW
                'test_annotations': os.path.join(cam16_dir, 'Camelyon16_Test/lesion_annotations'), # NEW
        ...
        if cam17_dir is not None:
            ...
            self._path['cam17'] = {
                ...
                'annotations': os.path.join(cam17_dir, 'training/lesion_annotations'),
